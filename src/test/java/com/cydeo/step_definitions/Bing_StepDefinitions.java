...
public class Bing_StepDefinitions {
    ...
    public void user_is_on_the_bing_search_page() {
        ...
        Driver.getDriver().findElement(By.id("bnp_btn_accept")).click();
    ...
    public void should_see_orange_in_the_title() {

        BrowserUtils.verifyTitle("orange - Arama");
    ...
    @Then("should see {string} in the title")
    public void shouldSeeInTheTitle(String expectedTitle) {
