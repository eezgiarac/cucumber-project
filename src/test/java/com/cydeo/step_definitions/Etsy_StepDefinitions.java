...
public class Etsy_StepDefinitions {
    ...
    public void user_should_see_title_is_as_expected() {
        ...
        //String expectedTitle = Driver.getDriver().getTitle(); //Amazon.com. Spend less. Smile more.
        String expectedTitle = "Etsy Italia - Acquista regali fatti a mano, vintage, personalizzati e unici per tutti";
    ...
    public void user_sees_wooden_spoon_is_in_the_title() { //Wooden spoon - Etsy Italia
        BrowserUtils.verifyTitle("Wooden spoon - Etsy Italia");
